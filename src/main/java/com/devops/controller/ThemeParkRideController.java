...
import com.devops.entity.JsonSet;
...
public class ThemeParkRideController {
    ...
    public ThemeParkRide createRide(@Valid @RequestBody JsonSet themeParkRide) {
    	...
    	ThemeParkRide themePark = new ThemeParkRide(themeParkRide.name, themeParkRide.getDescription(), themeParkRide.getThrillFactor(), themeParkRide.getVomitFactor());
    	
        return themeParkRideRepository.save(themePark);
    }
}